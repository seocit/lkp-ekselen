...
@section('content')
    <div class="space-y-4">
        <button type="button" onclick="window.location.href='{{ route('tambah inbox')}}'" class="bg-purple-300 text-purple-900 font-semibold px-4 py-2 rounded-full hover:bg-purple-400 transition">
            Buat Pengumuman
        </button>
            ...
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-4 relative">
                <div class="flex justify-between items-start mb-2">
                    ...
                    <div class="flex space-x-3 text-gray-600">
                        <!-- Trash Icon -->
                        <button aria-label="Delete" class="hover:text-red-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5-4h4m-4 0a1 1 0 00-1 1v1h6V4a1 1 0 00-1-1m-4 0h4" />
                            </svg>
                        </button>
                        <!-- Edit Icon -->
                        <button aria-label="Edit" class="hover:text-blue-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
