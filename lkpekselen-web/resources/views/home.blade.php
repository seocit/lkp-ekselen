...
@section('title', 'Home')
@section('content')
    <div class="bg-emerald-600 px-28 py-46">
        <div>
            <article class="text-wrap w-146">
    ...
    <div class="mx-64 my-24 text-center">
        <p class="text-2xl font-medium text-indigo-900">ABOUT</p>
        ...
        <div class="grid grid-flow-col justify-items-center-safe gap-10 mt-14">
            <div class="w-48">
                <div class="bg-emerald-600">01</div>
                <p class="text-xl font-medium text-indigo-900">Akreditasi</p>
                <p>LKP/LPK Ekselen Sudah Terakreditasi B</p>
            </div>
            <div class="w-48">
                <div class="bg-emerald-600">02</div>
                <p class="text-xl font-medium text-indigo-900">Evaluasi dan Ujian</p>
                <p>Evaluasi diadakan pada pertengahan program dan ujian kenaikan diadakan pada setiap akhir program</p>
            </div>
            <div class="w-48">
                <div class="bg-emerald-600">03</div>
                <p class="text-xl font-medium text-indigo-900">Frekuensi Kursus</p>
                <p>Kegiatan kursus dikelas berlangsung 3x/ minggu. Program pelatihan setiap paket/tingkat berlangsung 5 bulan.</p>
            </div>
        </div>
    </div>

    <div class="px-64 py-24 text-center bg-green-50">
