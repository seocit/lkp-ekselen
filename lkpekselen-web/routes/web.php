...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::post('/pembayaran/{id}/verifikasi', [PembayaranController::class, 'verifikasiPembayaran'])->name('pembayaran.verifikasi');
    });
    ...
    Route::get('/bukti-pembayaran-siswa', [PembayaranController::class, 'showPembayaran'])
        ->name('bukti-pembayaran-siswa')
        ->middleware('can:view_bukti_pembayaran');
    Route::get('/download/{id}', [PembayaranController::class, 'download'])
        ->name('download-bukti-pembayaran')
        ->middleware('can:view_bukti_pembayaran');
    Route::get('/pembayaran/view/{id}', [PembayaranController::class, 'view'])
        ->name('view-bukti-pembayaran');
